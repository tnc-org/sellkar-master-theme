        ...
        options ? (
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => onChange(e.target.value)}
              placeholder={placeholder}
              className={`h-10 w-full px-3 pr-10 rounded-lg border-2 text-gray-700 text-sm outline-none transition-colors ${
          ...
          <input
            ...
            onChange={(e) => onChange(e.target.value)}
            placeholder={placeholder}
            className={`h-10 px-3 rounded-lg border-2 text-gray-700 text-sm outline-none transition-colors ${
              error ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
            }`}
          />
        )
