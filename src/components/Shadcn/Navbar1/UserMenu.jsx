...
/**
 * UserMenu — avatar button + dropdown with Profile & Logout.
 * Props:
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className="w-9 h-9 rounded-full overflow-hidden cursor-pointer ring-2 ring-gray-200 hover:ring-blue-400 transition-all focus:outline-none"
      >
        {user.profilePhoto ? (
          <img src={user.profilePhoto} alt={initials} className="w-full h-full object-cover" />
        ) : (
